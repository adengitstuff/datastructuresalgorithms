...
public class prQuadTree<T extends Compare2D<? super T>> {
    ...
    private prQuadNode insertHelper(
        ...
        /** Otherwise, we're at a leaf node. */
            ...
            /** This was, for some reason, the only way
             * this class would run. Even if I called SW = null, etc in the constructor for
        ...
        /** This is a redundant line that I find comfort in */
        //else if (root.getClass().equals(refinternal.getClass())) {
            ...
            // constant loop near the NW quadrant. After recognizing it wasn't a
            // syntax problem, I just shamelessly changed them to if
            // statements - it then worked. :') sorry
            
            /** The setters here are redundant*/
    ...
    public ArrayList<T> findLong(
        ...
        // throw each of these values into our array. Arraylist 
